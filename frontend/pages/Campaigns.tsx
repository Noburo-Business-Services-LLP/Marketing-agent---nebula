        ...
        <div className="space-y-6 animate-in fade-in duration-500">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[#ffcc29] text-black rounded-lg font-semibold text-sm hover:bg-[#e6b825] transition-colors disabled:opacity-50"
            >
              {loadingSuggestions ? (
